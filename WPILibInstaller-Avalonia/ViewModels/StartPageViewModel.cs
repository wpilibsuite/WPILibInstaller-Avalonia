...
#pragma warning restore CS8618 // Non-nullable field is uninitialized. Consider declaring as nullable.
        ...
        {
            var file = await programWindow.ShowFilePicker("Select Resource File", RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "*.zip" : "*.tar.gz", Environment.GetFolderPath(Environment.SpecialFolder.Personal));
        ...
        {
            var file = await programWindow.ShowFilePicker("Select Support File", RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "*.zip" : "*.tar.gz", Environment.GetFolderPath(Environment.SpecialFolder.Personal));
